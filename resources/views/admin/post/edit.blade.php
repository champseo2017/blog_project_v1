            ...
            <form role="form" action="{{ route('post.update',$post->id) }}" method="post" enctype="multipart/form-data" name="postfrom-admin" onsubmit="return validateForm()">
              ...
              <div class="box-body">
                ...
                <div id="validation-4"></div>
                  ...
                  <input  name="image" id="image" value="{{ $post->image }}" class="bootstrap-wysihtml5-insert-image-url form-control" data-wysihtml5-dialog-field="src">
                  
                </div>
                <p>ฝากไฟล์รูปได้ที่เว็บไซต์: <a href="https://www.picz.in.th/" target="_blank">picz.in.th</a></p>
                <div class="checkbox">
                  <label>
